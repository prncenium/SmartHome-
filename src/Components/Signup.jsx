...
function Signup() {
  ...
  <div className="max-w-md mx-auto p-9  bg-white shadow-md rounded-lg ">
    ...
    <h2 className='text-2xl font-semibold mb-4 text-center'>Signup for SmartHome🏠</h2>
    <form onSubmit={handleSubmit}>
        ...
        <button type='submit' disabled={loading} className='w-full p-2 bg-blue-600 text-white rounded hover:bg-blue-400' > {loading ? "Signing up..." : "Sign Up"}</button>
